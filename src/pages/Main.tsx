...
export default function MainPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="mx-auto max-w-100% px-6 pb-10 bg-sky-500">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-10 items-center">
          <div className="space-y-8">
            <h1 className="text-white text-4xl md:text-4xl font-bold px-[153px] leading-tight">큐브 AI, 실무형 인공지능 학습의 시작</h1>
            <p className="text-white text-lg md:text-xl font-medium  px-[153px] leading-relaxed">AI를 처음 배우는 사람도, 개념부터 실습까지<br />한 번에 익히고 바로 활용할 수 있습니다.</p>
          </div>
      ...
      <section id="curriculum" className="mx-auto max-w-7xl px-6 py-10 border-b border-[#C3CCD9]/60 bg-white">
